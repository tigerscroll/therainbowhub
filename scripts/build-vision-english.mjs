...
add(10, 'How many squares can you count in this rectangular grid, including all sizes?', ['6','7','8','9'], '8', gridLines(3,2), 'Six unit squares plus two 2-by-2 squares make eight.', 'spatial_orientation');
