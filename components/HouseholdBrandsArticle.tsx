      ...
      {started ? (
        <section id="household-brands-start" className="timed-gallery timed-article" aria-label="Old household brands worth money article">
          <header className="timed-gallery__intro timed-article-header">
            <p className="timed-kicker">Collector watch</p>
            <h2>Check the cupboards before you throw these out</h2>
            <p className="timed-article-byline">The Rainbow Hub Lifestyle Desk · Updated this month</p>
