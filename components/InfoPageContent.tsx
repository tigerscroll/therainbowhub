...
const infoPageLabels: Record<SupportedLocale, { related: string }> = {
  ...
  pl: { related: "Powiązane informacje" },
  sv: { related: "Relaterad information" },
  da: { related: "Relaterede oplysninger" },
  nb: { related: "Relatert informasjon" },
  tr: { related: "İlgili bilgiler" },
  cs: { related: "Související informace" },
  ro: { related: "Informații conexe" },
  hu: { related: "Kapcsolódó információk" },
  fi: { related: "Aiheeseen liittyvää tietoa" },
  el: { related: "Σχετικές πληροφορίες" },
  id: { related: "Informasi terkait" },
  th: { related: "ข้อมูลที่เกี่ยวข้อง" },
  vi: { related: "Thông tin liên quan" },
  ms: { related: "Maklumat berkaitan" },
  fil: { related: "Kaugnay na impormasyon" },
  uk: { related: "Пов’язана інформація" },
  bg: { related: "Свързана информация" },
  hr: { related: "Povezane informacije" },
  sr: { related: "Повезане информације" },
  sk: { related: "Súvisiace informácie" },
};
